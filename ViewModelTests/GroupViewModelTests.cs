...
namespace Test_UBB_SE_2024_Popsicles.GroupViewModelTests
{
    public class GroupViewModelTests
    {
        ...
        public void Setup()
        {
            mockGroup = new Mock<Group>(It.IsAny<Guid>(), It.IsAny<Guid>(), "Group GroupName", "test", It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<string>());
            ...
            mockRequest = new Mock<JoinRequest>(It.IsAny<Guid>(), It.IsAny<Guid>(), "JoinRequest GroupName", It.IsAny<Guid>());
            ...
            testViewModel.RequestsToJoinTheGroup = new ObservableCollection<JoinRequest>() { mockRequest.Object };
            testViewModel.PostsMadeInTheGroupChat = new ObservableCollection<GroupPost>() { mockPostInGroup.Object };
            testViewModel.CollectionOfPolls = new ObservableCollection<GroupPoll>() { mockPoll.Object };
        ...
        {
            ObservableCollection<JoinRequest> actualRequests = new ObservableCollection<JoinRequest>()
            {
                mockRequest.Object
            };
